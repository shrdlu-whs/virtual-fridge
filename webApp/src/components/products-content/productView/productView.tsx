    ...
    <Grid container direction="row" justify="center" alignItems="center">
      <Grid item sm={9} md={5} lg={4} xl={3}>
        <Paper className={classes.addProductContentContainer}>
            ...
            <Grid container spacing={2}>
              <Grid item xs={6}>
                <TextField
                  ...
                  error={
                    touched.totalQuantity && errors.totalQuantity !== undefined
                  }
                  margin="normal"
                  fullWidth
                />
              ...
              {categoryStore!.categories.map((category) => {
                ...
                return (
                  ...
                  >
                    ...
                    <ListItemText
                      id={labelId}
                      primary={t(`label.product_category_${category.name}`)}
                    />
                  </ListItem>
                );
              })}
          ...
          <Grid container spacing={2}>
            <Grid item xs={6}>
              <Button onClick={handleReturnToOverview} color="primary">
                {t("action.cancel")}
              </Button>
            </Grid>
            <Grid item xs={6}>
